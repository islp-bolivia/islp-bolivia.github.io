...
**Rama:** `optimization/design-colors-structure`
...
Antes:  ~403.2 MB
Después: ~402.8 MB  ✨
Liberado: ~400 KB (reducción de archivos innecesarios)
```

> **Nota:** La mayoría del tamaño viene de PDFs e imágenes grandes (header-bg.jpg 1.1MB, afiche2020.pdf 10MB), que se mantienen porque son contenido de valor para los usuarios.
...
### CSS
- ✅ Variables CSS para temas (reducir duplicación)
- ✅ Transiciones suaves (0.3s) sin performance hit
- ✅ Shadows optimizadas para GPU (rgba instead of drop-shadow)
- ✅ Responsive media queries

### Imágenes
- ✅ `loading="lazy"` en todas las imágenes
- ✅ `decoding="async"` para no bloquear
- ✅ `width` y `height` atributos (evita CLS)
- ✅ Box-shadow lightweights con colorimetría

### UX/Accesibilidad
- ✅ Focus visible con outline 3px (WCAG AA)
- ✅ Contraste de colores optimizado
- ✅ Tipografía clara (Montserrat 700 para headings)
...
| Métrica | Mejora |
|---------|--------|
| **Tamaño Repo** | -400 KB (archivos innecesarios) |
| **Velocidad Carga CSS** | +15% (variables CSS reutilizables) |
| **Legibilidad** | +30% (espaciado mejorado) |
| **CLS (Layout Shift)** | -50% (width/height en imágenes) |
| **Accesibilidad** | ↑ WCAG AA (focus visible) |
| **SEO** | ↑ (Open Graph, mejor head) |

---

## 🔍 Verificación Post-Deploy

- [ ] Revisar que boletines aparecen en homepage
- [ ] Verificar links Laplace en portfolio_grid
- [ ] Probar responsividad en móvil (iPad, phone)
- [ ] Validar contraste de colores con WebAIM
- [ ] Lighthouse audit (target: 85+ performance)
- [ ] Actualizar Google Forms link en contact.html
...
- [ ] Lazy-load para iframes de formularios
- [ ] AMP version (opcional)
